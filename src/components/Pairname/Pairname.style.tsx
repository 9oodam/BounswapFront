export const Divstyle = {
  ...
  SideBarLogoPair: `relative pc:w-[70px] mobile:w-[80px] h-[50px] `,
  SideBarLogoLeft: `pc:w-[36px] pc:h-[36px] mobile:w-[40px] mobile:h-[40px] absolute rounded-coinLogo top-[8px] border-2`,
  SideBarLogoRight: `pc:w-[36px] pc:h-[36px] mobile:w-[40px] mobile:h-[40px] absolute left-5 rounded-coinLogo top-[8px] border-2`,
};
