    ...
    <>
      <div className="mobile:ml-7 mobile:mr-7">
        ...
        <div className={Divstyle.Titlesize}>
          ...
          <div
            className={`border-2 pc:w-[170px] mobile:w-[120px] border-deepBlack rounded-full cursor-pointer flex items-center justify-evenly mobile:text-[13px] ${copied ? `bg-deepBlack` : ``
              }`}
            onClick={handleCopy}
          >
