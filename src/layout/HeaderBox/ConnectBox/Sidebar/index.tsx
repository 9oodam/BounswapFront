...
const Sidebar: React.FC<{
  ...
  return (
    <>
      <div
        className={`transition-all ease-in-out duration-300 fixed pcSiedbar:top-[8px] pcSiedbar:bottom-0 text-deepBlack pcSiedbar:w-[375px] mobileSiedbar:w-full mobileSiedbar:min-w-[400px] mobileSiedbar:left-0 mobileSiedbar:right-0 mobileSiedbar:bottom-0 mobileSiedbar:h-[75%] h-custom z-50 rounded-[12px] bg-[#edf9e4] ${
          isOpen
